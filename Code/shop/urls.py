...
urlpatterns =[
    ...
    path('kala/<slug:kalaslug>/', KalaDetailView, name = 'KalaDetailView'),
    ...
    # path('profile/' ,Profile.as_view() , name='profile'), #TODO: Profile
    ...
    # path('checkout/' ,checkout , name='checkout'), #TODO: Checkout
