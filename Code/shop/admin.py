...
#         '%d user is inactivated',
#         '%d user are inactivated',updated)% updated, messages.SUCCESS)
#
...
#     list_display = ['kala','price','off','instock',]
#     list_filter = ['kala','price','off',]
#     list_display_links = ['kala']
#     sortable_by = ['kala', 'price','off',]
#     search_fields = ['kala','saller',]
...
# class SalledAdmin(admin.ModelAdmin):
...
#     list_display = ['username','product','count','saller','coupon','payed',]
#     list_filter = ['product','saller','payed',]
#     search_fields = ['username','saller','product',]
#
#
